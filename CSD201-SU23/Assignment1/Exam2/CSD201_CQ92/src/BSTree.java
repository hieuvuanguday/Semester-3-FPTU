...
public class BSTree {
     ...
     * style), and line k+1 (for size), and line k+2 (for color)
     *
     ...
     * attribute style of Item does NOT start with 'B'. The output of this
     ...
     * in the file 'data.txt', the content of 'f1.txt' after insertion should
     * be: (A,7,9) (C,4,3) (D,8,6) (E,2,5) (Y,6,-7) (F,-6,7) (F,-6,7) (E,2,5)
    ...
    void insert(String xStyle, int xSize, int xColor) {
        if (!xStyle.startsWith("B")) {
            this.root = insertRec(this.root, new Item(xStyle, xSize, xColor));
        }
    }
    ...
    void f2() throws Exception {
         ...
         * nodes that has Item's color lager than 6. Hint: This method is
         ...
         * doing BFS but considering only color lager than 6. The output f2()
    ...
    void f3() throws Exception {
         ...
         * insertion. Hint: (1) Implement a method to calculate the size or
         * number of nodes in tree (2) Insert the new Item('Z', 15, Tree Size)
         ...
         * 'f3.txt' after running this method is: (H,1,7) (K,4,6) (J,5,5)
         * (I,3,9) (F,2,3) (G,7,8) (D,6,1) (E,9,4) (C,8,2) (H,1,7) (K,4,6)
         * (J,5,5) (I,3,9) (F,2,3) (G,7,8) (D,6,1) (Z,15,9) (E,9,4) (C,8,2)
         */
        //-------------------------------------------------------------------
        //------ Start your code here----------------------------------------
    ...
    void f4() throws Exception {
         ...
         * The output f4() will be written into the file 'f4.txt'. Therefore you
         * should open this file to see/test your code output. Example: With the
         * data provided in 'data.txt', the content of 'f4.txt' after running
         * this method is: (H,1,7) (K,4,6) (J,5,5) (I,3,9) (F,2,3) (G,7,8)
         * (D,6,1) (E,9,4) (C,8,2) (H,1,7) (K,4,6) (J,5,4) (I,3,8) (F,2,2)
         * (G,7,8) (D,6,0) (E,9,4) (C,8,1)
         */
        //-------------------------------------------------------------------
        //------ Start your code here----------------------------------------

        decreaseNonLeafColors(root);
        //------ End your code here------------------------------------------
        //-------------------------------------------------------------------
        postOrder(root, f);
        f.writeBytes("\r\n");
    ...
    void decreaseNonLeafColors(Node p) {
        if (p == null || (p.left == null && p.right == null)) {
            return;
        }

        if (p.left != null) {
            decreaseNonLeafColors(p.left);
            if (p.left.left != null || p.left.right != null) {
                p.left.getInfo().setColor(p.left.getInfo().getColor() - 1);
            }
        }

        if (p.right != null) {
            decreaseNonLeafColors(p.right);
            if (p.right.left != null || p.right.right != null) {
                p.right.getInfo().setColor(p.right.getInfo().getColor() - 1);
            }
        }
    }
}
